...
/**
 * EditableText.js
 *   A library to support editable text in Konva.js.
 */
...
// +----------------------------+------------------------------------
// | Extensions to Konva.Text |
// +----------------------------+

Konva.Text.prototype.isEditable = false;
Konva.Text.prototype.isActive = false;
Konva.Text.prototype.setEditable = function(state){this.isEditable = state;}
Konva.Text.prototype.defaultText = null;
Konva.Text.prototype.drawMethod = function(){};
Konva.Text.prototype.capitalized = false;
Konva.Text.prototype.aligned = "left";
Konva.Text.prototype.matchingCharacters = /[0-9.]/;
Konva.Text.prototype.parentLayer = function(){return this.getLayer()};
Konva.Text.prototype.measureText = function(family, size, text){
...
Konva.Text.prototype.removeFocus = function(){
  if(this.cursor != null){
...
Konva.Text.prototype.addCursor = function(moveToClosest, mouse){
  var x = this.x();
...
var makeVariableGroup = function(x, y) {
  ...
  /* create circle shape. */
  var newHex = new Konva.RegularPolygon({
    sides: 6,
    x: variableWidth,
    y: variableRadius,
...
It returns a Konva tween that will move target to xEnd, without changing y value,
...
var createEditableText = function (group) { 
  ...
  var editableTextBox = new Konva.Text({
    x: -((editableTextWidth - functionTotalSideLength) / 2) -4,
    y: functionTotalSideLength + 5,
    text: 'Enter a Value',
...
/* workaround to make sure intersections work while dragging
  KonvaJS's getIntersection doesn't work when using the 'mousedown' event
  to startDrag
*/
 ...
 */
 ...
 var menuButtonLayer = new Konva.Layer();
 var menuArrowLayer = new Konva.Layer();
 var menuControlLayer = new Konva.Layer();
 var toolboxLayer = new Konva.Layer();
 var workLayer = new Konva.Layer();
 var borderLayer = new Konva.Layer();
 var funBarLayer = new Konva.Layer();
 var dragLayer = new Konva.Layer();
 var textLayer = new Konva.Layer();
 var labelLayer = new Konva.Layer();
 var screenLayer = new Konva.Layer();
 var renderLayer = new Konva.Layer();
 ...
 */
export function initializeStage(containerName) {
  // Create the object
...
var makeLabel = function(group) {
	...
	if (rep == 'rgb') {
		var label = new Konva.Group({
			x: group.x(),
			y: group.y()
		});

		var rgbText = new Konva.Text({
			text: text,
			x: -110,
		...
		/*
		label.add(new Konva.RegularPolygon({
...
var valuesButton = new Konva.Group({
x: menuCornerWidth
});
menuButtonLayer.add(valuesButton);

var valuesButtonBox = new Konva.Rect({
x:0,
y:0,
width: buttonWidth,
height: menuHeight,
...
var valuesButtonRect = new Konva.Rect({
x: buttonWidth / 2,
y: menuHeight / 4,
width: valueSideLength,
height: valueSideLength,
...
var valuesButtonText = new Konva.Text({
text: 'add a value',
x: 0,
...
var functionsButton = new Konva.Group({
x: menuCornerWidth + buttonWidth
});
menuButtonLayer.add(functionsButton);

var functionsButtonBox = new Konva.Rect({
x:0,
y:0,
width: buttonWidth,
height: menuHeight,
...
var functionsButtonRect = new Konva.Rect({
...
var functionsButtonText = new Konva.Text({
text: 'add a function',
x: 0,
y: menuHeight / 2 + menuHeight / 4,
width: buttonWidth,
...
* toggle labels text
*/
var toggleTag = new Konva.Group ({
  x: (width / 90),
  y: menuHeight + (width / 90)
});
borderLayer.add(toggleTag);

toggleTag.add(new Konva.Text({
  x:0,
  y:0,
...
var addScrollArrows = function(type) {
  ...
  var leftArrowBox = new Konva.Rect({
    x: 0,
    y: 0,
    width: arrowWidth,
    height: menuHeight,
  ...
  var leftArrowTri = new Konva.Shape({
    sceneFunc: function(context) {
      context.beginPath();
      context.moveTo(0,0);
  ...
  var rightArrow = new Konva.Group({
    x: rightX,
    y: 0,
    direction: 'right',
    type: type,
  ...
  var rightArrowBox = new Konva.Rect({
    x: 0,
    y: 0,
    width: arrowWidth,
    height: menuHeight,
  ...
  var rightArrowTri = new Konva.Shape({
    sceneFunc: function(context) {
      context.beginPath();
      context.moveTo(0,0);
      context.lineTo(-triX, -triY);
...
//LEFT CORNER BUTTONS
var bottomCover = new Konva.Rect({
  x:0,
  y:0,
...
//var setupToolbox = function() {
  ...
  var toolboxGroup = new Konva.Group({
    x: width * .9,
    y: height * .2,
    draggable: false,
  ...
  var toolboxRect = new Konva.Rect({
    x:0,
    y:0,
    width: toolboxWidth,
  ...
  var toolboxControl = new Konva.Rect({
    x:0,
    y:-toolboxShift,
    width: toolboxWidth,
    height: toolboxShift,
  ...
  //add the work tool
  var workToolGroup = new Konva.Group({
    x: toolboxShift,
    y: toolboxShift,
    name: 'workTool'
  });
  ...
  var workToolButton = new Konva.Rect({
    x: 0,
    y: 0,
  ...
  var workToolSymbol = new Konva.Shape({
    sceneFunc: function(context) {
      context.beginPath();
      context.moveTo(0, 0);
      context.lineTo(5, 12);
  ...
  var workToolCover = new Konva.Rect({
    x: 0,
    y: 0,
    width: toolboxButtonSize,
    height: toolboxButtonSize
  ...
  var lineToolGroup = new Konva.Group({
    x: toolboxShift,
  ...
  var lineToolButton = new Konva.Rect({
    x: 0,
    y: 0,
    width: toolboxButtonSize,
    height: toolboxButtonSize,
  ...
  var lineToolLine = new Konva.Line({
  ...
  /* Transparent box that covers the button to ensure its function when clicked on */
  var lineToolCover = new Konva.Rect({
    x: 0,
    y: 0,
    width: toolboxButtonSize,
    height: toolboxButtonSize
  ...
  var deleteToolGroup = new Konva.Group({
    x: toolboxShift,
  ...
  var deleteToolButton = new Konva.Rect({
    x: 0,
    y: 0,
    width: toolboxButtonSize,
    height: toolboxButtonSize,
  ...
  var deleteToolSym1 = new Konva.Rect({
  ...
  var deleteToolSym2 = new Konva.Rect({
  ...
  /* Transparent box that covers the button to ensure its function when clicked on */
  var deleteToolCover = new Konva.Rect({
    x: 0,
    y: 0,
    width: toolboxButtonSize,
    height: toolboxButtonSize
  ...
  var undoButton = new Konva.Shape({
    sceneFunc: function(context) {
      context.beginPath();
      context.moveTo(0, 0);
  ...
  var redoButton = new Konva.Shape({
    sceneFunc: function(context) {
      context.beginPath();
      context.moveTo(0, 0);
      context.lineTo(35, 30);
...
// Create functions to Move Menu Items
	...
	};var openWsGroup = new Konva.Group({
	x: popSaveWsGroupX,
	y: popSaveWsGroupY,
	visible: false
});
...
var nameOpenWsText = new Konva.Text({
	text: "Name:",
	x: popTextShiftX,
	y: popTextShiftX,
	fill: 'black',
...
var nameOpenWsRect = new Konva.Rect ({
...
var nameOpenWsEditText = new Konva.Text({
...
var popOpenWsCancelButtonGroup = new Konva.Group({
...
var popOpenWsCancelButton = new Konva.Rect ({
	x: 0,
	y: 0,
...
var popOpenWsCancelButtonText = new Konva.Text({
	text: "Cancel",
	x: 0,
...
var popOpenWsButtonGroup = new Konva.Group({
...
var popOpenWsButton = new Konva.Rect ({
	x: 0,
	y: 0,
	width: popOpenWsButtonWidth,
	height: popOpenWsButtonHeight,
...
var popOpenWsButtonText = new Konva.Text({
	text: "Open",
	x: 0,
	y: (popOpenWsButtonHeight - 16) / 2,
	width: popOpenWsButtonWidth,
...
var popSaveGroup = new Konva.Group({
  x: popSaveGroupX, 
  y: popSaveGroupY,
  visible: false
});
...
var popSaveRect = new Konva.Rect ({
  x: 0,
  y: 0,
  width: popRectWidth,
...
var renderPopText = new Konva.Text({
  text: "",
  x: popTextShiftX,
  y: popTextShiftY,
  width: popTextWidth,
...
var nameEditText = new Konva.Text({
  x: popTextShiftX + (nameTextShift * 1.1),
  y: popTextShiftY + (popTextHeight * 1.4),
  text: 'Enter a Name',
  fontSize: 14,
...
// ERROR TEXT
var popErrorText = new Konva.Text({
  x: popTextShiftX,
...
//CANCEL BUTTON GROUP
var popCancelButtonGroup = new Konva.Group({
  x: popTextShiftX,
...
var popCancelButton = new Konva.Rect ({
  x: 0,
  y: 0,
...
var popCancelButtonText = new Konva.Text({
  text: "Cancel",
  x: 0,
...
var popDownloadButtonGroup = new Konva.Group({
...
var popDownloadButton = new Konva.Rect ({
  x: 0,
  y: 0,
  width: popButtonWidth,
  height: popButtonHeight,
...
var popDownloadButtonText = new Konva.Text({
  text: "Download",
  x: 0,
  y: (popButtonHeight - 16) / 2,
  width: popButtonWidth,
...
//SAVE BUTTON GROUP
var popSaveButtonGroup = new Konva.Group({
...
var popSaveButton = new Konva.Rect ({
  x: 0,
  y: 0,
  width: popButtonWidth,
  height: popButtonHeight,
...
var popSaveButtonText = new Konva.Text({
  text: "Save",
  x: 0,
  y: (popButtonHeight - 16) / 2,
  width: popButtonWidth,
